(function() {
    ...
    var debug = function() {
        if (LOG_DEBUG) {
            arguments[0] && (arguments[0] = ("[Zipperr] " + arguments[0]));
    ...
    function showBan() {
        ...
        debug("Please report this to the Zipperr developer.");
    ...
    /*
        This is the core AI behind Zipperr.
    ...
    */
    ...
    function createUI(body) {
        ...
        title.innerHTML = "<strong>Zipperr 2</strong>";
    ...
    function createOptsMenu() {
        ...
        lbl.innerHTML = "Customize Zipperr";
        ...
        wpm.onchange = function() {
            if (getLocalStorage("speedChange") != null) {
                ...
                alert('It is not recommended to alter the default speed of Zipperr, be careful! This message will not be shown again.');
        ...
        tips.innerHTML = "Press escape to hide all of the Zipperr menus.<br><a href='https://discord.gg/NkhuDZS'>Join our Discord!</a>";
    ...
    function changeTip(node) {
        setTimeout(function() {
            ...
            node.innerHTML = "";
            node.innerHTML += FONT;
            node.innerHTML += '<center style="font-family:Ubuntu;">Zipperr - NitroType simplified.<br>Version: ' + VERSION + '</center>';
        }, 1000);
    }
    ...
    setInterval(function() {
        _setTitle.call(document, "Zipperr 2");
    }, 100);
